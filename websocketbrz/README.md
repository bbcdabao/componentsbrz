  ...
  - Instructions for use
    ...
    **bbcdabao.componentsbrz.websocketbrz.api**<br>
    It includes 4 interfaces:<br>
      - 1. AbstractSessionServer:It is an abstract class used to initialize access to websocket sessions and receive messages. When there is a reply access, its subclass will be created. The ISessionFactory factory subclass is responsible for creating.
      - 2. IGetMsgForSend:
      - 3. IRegGetMsgForSend:
      - 4. ISessionFactory:
